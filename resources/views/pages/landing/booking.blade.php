...
@section('content')
    ...
    <section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
        <div class="m-auto text-center h-auto">
            ...
            To continue payment, please contact directly <br class="lg:block hidden">our Freelancer through WhatsApp</p>
            ...
            <a href="{{ route('index') }}" class="bg-serv-services-bg text-serv-bg text-md font-medium py-4 w-80 my-2 rounded-2xl text-center inline-block">Back to Home</a>
